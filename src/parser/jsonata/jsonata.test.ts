...
describe("parser", () => {
  ...
  describe("jsonata filter", () => {
    it("should filter data correctly with single element", async () => {
      expect(await uql(`scope "Countries" | jsonata "*[Country='India'][]"`, { data })).toStrictEqual([
        {
          Country: "India",
        },
      ]);
    ...
    it("should filter data correctly with multiple elements", async () => {
      expect(await uql(`scope "Countries" | jsonata "*[Country in ['India','United Kingdom']][]"`, { data })).toStrictEqual([
        {
          Country: "India",
        },
        {
